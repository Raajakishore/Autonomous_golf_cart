...
def main():
    ...
    train_images = pickle.load(open("C:\\Users\\raaja\\Downloads\\full_CNN_train.p", "rb" ))

    # Load image labels
    labels = pickle.load(open("C:\\Users\\raaja\\Downloads\\full_CNN_labels.p", "rb" ))
    ...
    model.save('full_CNN_model23.h5')
